...
export ANDROID_BUILD_TOP := $(HOME)/android/master
LLVM_PREBUILTS_PATH := prebuilts/clang/host/linux-x86/clang-stable/bin
...
$(TARGET_ABL): abl_clean | $(ABL_OUT) $(INSTALLED_KEYSTOREIMAGE_TARGET)
	$(MAKE) -C . BOOTLOADER_OUT=./$(ABL_OUT) all $(VERIFIED_BOOT) $(USER_BUILD_VARIANT) CLANG_BIN=$(CLANG_BIN)
